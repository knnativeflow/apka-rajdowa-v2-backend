...
import {Administrator, AdministratorDoc, AdministratorRequest, USER_ROLE} from "models/Administrator";
...
async function changeRole(eventId: string, adminId: string, newRole: USER_ROLE): Promise<Response<AdministratorDoc[]>> {
